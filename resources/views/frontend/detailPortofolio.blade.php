    ...
    <section class="page-title" style="background-image:url({{asset('generalimg/'.$general->breadcrumb)}})">
        <div class="auto-container">
            ...
            <ul class="page-breadcrumb">
                ...
                <li><a href="{{route('portofolio')}}">{{$mainMenu[2]->name}}</a></li>
                <li>{{$data->judul}}</li>
            </ul>
        </div>
    </section>
    ...
    <section class="portfolio-single">
        <div class="auto-container">
            <div class="content-box">
                <div class="image-box">
                    <figure class="image"><img src="{{asset('portofolioimg/'.$data->image)}}" alt="{{$data->judul}}"></figure>
                </div>
            ...
            <div class="related-products">
                ...
                <div class="row">
                    ...
                    <div class="portfolio-block col-lg-3 col-md-6 col-sm-12">
                        <div class="inner-box">
                            <div class="image-box"><figure class="image"><img src="{{asset('portofolioimg/'.$item->image)}}" alt="{{$item->judul}}"></figure></div>
                            ...
                            <div class="portfolio-hover">
                                ...
                                <a href="{{asset('portofolioimg/'.$item->image)}}" alt="{{$item->judul}}" class="lightbox-image link" data-fancybox="portfolio"></a>
                                <h3><a href="{{route('detail.portofolio', $item->slug)}}">{{$item->judul}}</a></h3>
                            </div>
                        </div>
                    </div>
                    @endforeach
