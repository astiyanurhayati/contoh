...
@section('content')
    ...
    <div class="agency_heading">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="agency_text_porto">
                        <h3>Jelajahi Ragam Solusi Terbaik yang Kami Tawarkan</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-5 col-md-6">
                    <div class="single_work">
                        <div class="work_thumb">
                            <img src="{{ asset('portofolioimg/' . $portofolios[0]->image) }}"
                                alt="{{ $portofolios[0]->judul }}">
                    ...
                    <div class="single_work">
                        <div class="work_thumb">
                            <img src="{{ asset('portofolioimg/' . $portofolios[1]->image) }}"
                                alt="{{ $portofolios[1]->judul }}">
                            <div class="work_hover">
                                <div class="work_inner">
                ...
                <div class="col-xl-5 offset-xl-2 col-md-6">
                    <div class="single_work spacec-top">
                        <div class="work_thumb">
                            <img src="{{ asset('portofolioimg/' . $portofolios[2]->image) }}"
                                alt="{{ $portofolios[2]->judul }}">
                            <div class="work_hover">
                                <div class="work_inner">
                    ...
                    <div class="single_work">
                        <div class="work_thumb">
                            <img src="{{ asset('portofolioimg/' . $portofolios[3]->image) }}"
                                alt="{{ $portofolios[3]->judul }}">
                            <div class="work_hover">
                                <div class="work_inner">
