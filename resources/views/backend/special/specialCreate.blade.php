...
@section('titleheader', 'Create Special')
...
<div class="card card-primary">
    ...
    <form class="_form" action="{{route('special.store')}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card-body row">
            <div class="form-group col-md-6">
                <label>Judul</label>
                <input type="text" name="judul" placeholder="Masukan judul slider" class="form-control @error('judul') is-invalid @enderror" fdprocessedid="bp6kma">
                @error('judul')
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="desk" placeholder="Masukan sub judul slider" class="form-control @error('desk') is-invalid @enderror" fdprocessedid="m7zm6g">
                @error('desk')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
