...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Edit Slide Recipe</h3>
    </div>
    <form class="_form" action="{{route('slide-recipe.update', $data->id)}}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
            ...
            <div class="col-md-6">
                ...
                <div class="pl-4 ">
                    ...
                    <div style="width: 150px">
                        <img src="{{asset('sliderecipe/'.$data->gambar)}}" class="img-preview img-fluid d-blok">
                    </div>
                    @else
                    <div style="width: 150px">
