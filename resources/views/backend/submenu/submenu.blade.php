    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <a href="{{route('sub-menu.create')}}" class="btn btn-primary">
                ...
                <table class="table table-head-fixed text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td id="action-31">
                                <a href="{{route('sub-menu.edit', $menu->id)}}" class="btn btn-info btn-sm"><i class="fas fa-pencil-alt" aria-hidden="true"></i>&nbsp;&nbsp;Edit Menu</a>
                                <form id="deleteForm-{{$menu->id}}" action="{{route('sub-menu.destroy', $menu->id)}}" style="display:inline-block" method="POST" class="deleteForm-{{$menu->id}}">
                                    @method('DELETE')
                                    @csrf
