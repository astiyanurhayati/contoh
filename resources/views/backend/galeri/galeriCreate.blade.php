...
@section('titleheader', 'Create Galeri')
@section('page1', 'Home')
...
<div class="card card-primary">
    ...
    <form class="_form" action="{{route('galery.store')}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card-body row">
            ...
            <div class="col-md-6">
             ...
             <div class="form-group col-md-6">
                ...
                <input type="text" name="desk" placeholder="Masukan deskripsi" class="form-control  @error('desk') is-invalid @enderror" required value="{{old('desk')}}">
                @error('desk')
