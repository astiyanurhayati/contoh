...
@section('titleheader', 'Create Category blog')
@section('page1', 'Blog')
@section('title', ' Blog')
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Tambah Category Blog</h3>
    </div>
    <form class="_form" action="{{route('category-blog.store')}}" method="post" enctype="multipart/form-data">
        @csrf
